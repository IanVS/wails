...
Now that the CLI is installed, you can generate a new project by using the `wails3 init` command.
...
If you would rather use TypeScript:<br/>
    ...
    wails3 init -n myproject -t svelte-ts

</TabItem>
<TabItem value="React">
    Generate a <a href={"https://reactjs.org/"}>React</a> project using JavaScript with:<br/><br/>

    wails3 init -n myproject -t react

If you would rather use TypeScript:<br/>

    wails3 init -n myproject -t react-ts
...
If you would rather use TypeScript:<br/>
    ...
    wails3 init -n myproject -t vue-ts

</TabItem>
<TabItem value="Preact">
    Generate a <a href={"https://preactjs.com/"}>Preact</a> project using JavaScript with:<br/><br/>

    wails3 init -n myproject -t preact

If you would rather use TypeScript:<br/>

    wails3 init -n myproject -t preact-ts

</TabItem>
<TabItem value="Lit">
    Generate a <a href={"https://lit.dev/"}>Lit</a> project using JavaScript with:<br/><br/>

    wails3 init -n myproject -t lit

If you would rather use TypeScript:<br/>

    wails3 init -n myproject -t lit-ts

</TabItem>
<TabItem value="Vanilla">
    Generate a Vanilla project using JavaScript with:<br/><br/>

    wails3 init -n myproject -t vanilla

If you would rather use TypeScript:<br/>

    wails3 init -n myproject -t vanilla-ts
...
To see the other options available, you can run `wails3 init -help`.
